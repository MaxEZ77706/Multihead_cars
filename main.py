...
brand_sess = ort.InferenceSession("models/model N3/car_model.onnx", providers=providers)
color_sess = ort.InferenceSession("models/model N3/color_model.onnx", providers=providers)
